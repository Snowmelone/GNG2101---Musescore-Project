...
public:
    ...
    void playNotes(const notation::NoteValList& notes,
...
private:
    ...
    void doAddTrack(const engraving::InstrumentTrackId& instrumentTrackId,
    ...
    void playCurrentMeasure();
    void playCurrentStaff();
    void playCurrentRangeSelection();
